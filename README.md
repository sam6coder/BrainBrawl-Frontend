...
## Solution : 
Welcome to the Brain-Brawl frontend which is designed using Flutter . It utilise api developed using Django REST framework . This frontned application displays the platform where students from different universities can compete in knockout competitions involving assessments that challenge both accuracy and speed.
