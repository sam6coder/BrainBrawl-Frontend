...
class CompetitionView extends GetView<CompetitionController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     children: [
      //     Image.asset(
      //     'assets/images/brainbrawl2.jpg',
      //     width: MediaQuery.of(context).size.width,
      //
      //     fit: BoxFit.cover,
      //   ),
      //
      //       Text('Competitions', style: GoogleFonts.spaceMono()),
      //     ],
      //   ),
      //   elevation: 0,
      // ),
      // Profile Avatar positioned to the center-right
      // Positioned(
      //   right: 140, // Adjust the value to position it further right or left
      //   top: MediaQuery.of(context).size.height * 0.15, // Adjust the value to center vertically
      //   child: CircleAvatar(
      ...
      body: Column(
        children: [
          PreferredSize(
            preferredSize:
                Size.fromHeight(200.0), // Height of the custom AppBar
            child: Stack(
              children:[ Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/images/newt.jpg'),
                    fit: BoxFit.cover,
                  ),
                ),),
            Positioned(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        ElevatedButton(
                                                          onPressed: () async {
                                                            if (DateTime.parse(controller.competitions[index].time!).isAfter(DateTime.now()) &&
                                                                !(DateTime.parse(controller.competitions[index].time!).add(Duration(minutes: controller.competitions[index].roomTime!)).isBefore(
                                                                    DateTime
                                                                        .now()))) {
                                                              Get.showSnackbar(
                                                                  const GetSnackBar(
                                                              ...
                                                              return;
                                                            } else if (DateTime.parse(controller.competitions[index].time!).isBefore(DateTime.now()) &&
                                                                !(DateTime.parse(controller.competitions[index].time!)
                                                                    .add(Duration(
                                                                        minutes: controller
                                                                            .competitions[
                                                                                index]
                                                                    ...
                                                                    .isBefore(DateTime
                                                                        .now()))) {
                                                              await controller
                                                                  .registerParticipant(controller
                                                                      .competitions[
                                                                          index]
                                                                      .competitionId!);
                                                              controller.competitionTime(
                                                                  DateTime.parse(
                                                                      controller
                                                                          .competitions[
                                                                              index]
                                                              ...
                                                              return;
                                                                    ...
                                                                    controller
                                                                        .competitions[index]
                                                                        .time!)
                                                                .add(Duration(minutes: controller.competitions[index].roomTime!))
